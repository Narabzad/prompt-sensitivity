...
qpps = ["triviaqa_ClosenessCentrality.txt",
        "triviaqa_DegreeCentrality.txt",
        "triviaqa_IEF.txt",
        "triviaqa_PageRank.txt",
        "hotpotqa_ClosenessCentrality.txt",
        "hotpotqa_DegreeCentrality.txt",
        "hotpotqa_IEF.txt",
        "hotpotqa_PageRank.txt"]
